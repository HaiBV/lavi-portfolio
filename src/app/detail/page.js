      ...
      <header className={"fixed w-full top-0 left-0 grid grid-cols-10 gap-x-6 p-6 z-50"}>
        ...
        <section>
            <div className={"grid grid-cols-10 gap-x-6 px-6 mt-[232px] mb-[252px]"}>
                ...
                <p className={"col-start-9 flex items-center text-[21px] pt-3"}><a href="" className={"border-b-[1px] border-[#D0D1E7] pb-1.5"}>Visit Website</a></p>
            </div>
            <div className={"grid grid-cols-10 gap-x-6 px-6"}>
                <h3 className={"col-span-2 text-[24px] leading-none opacity-50"}>OVERVIEW</h3>
                <p className={"col-start-6 col-span-5 text-[42px] leading-none mb-[40px] tracking-tighter"}>MatYeu is a pioneering eye healthcare web-based application that leverages artificial intelligence to transform the way we manage eye health. It offers personalized diagnostics, all designed to make quality eye care more accessible and efficient.</p>
                <p className={"col-start-6 col-span-5 text-[42px] leading-none tracking-tighter"}>With MatYeu, users and healthcare professionals alike can enjoy a seamless and data-driven approach to vision care.</p>
                <ul className={"col-start-6 col-span-4 text-[21px] border-t-[1px] border-[#2D2E4D] pt-[73px] mt-[172px] mb-[99px]"}>
                ...
                <p className={"col-start-6 col-span-5 text-[42px] leading-none mb-[42px] tracking-tighter"}>This functionality allows the app to analyze the user's eye condition in real-time. By accessing the camera on a smartphone or computer, MatYeu can detect signs of eye fatigue, dryness, or other potential issues.</p>
                <p className={"col-start-6 col-span-5 text-[42px] leading-none mb-[161px] tracking-tighter"}>This proactive approach to eye health management is part of MatYeu's commitment to leveraging technology for better healthcare outcomes.</p>
                <div className={"col-span-10 mb-[40px]"}>
        ...
        <section className={"sec-contact relative"}>
            <Image className={"absolute w-full top-0 left-0"} src="/img/about/shape-footer.png" alt="Next project AON" width={1920} height={495}></Image>
            <Image className={"w-full"} src="/img/detail/contact-main.jpg" alt="Next project AON" width={1920} height={1080}></Image>
            <p className={"absolute w-full left-0 bottom-[13%] px-6 text-center text-[177px] leading-none"}><small className={"block text-[24px] mb-[16px]"}>Next project</small>AON</p>
        </section>
    </main>
  );
}