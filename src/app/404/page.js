      ...
      <header className={"fixed w-full top-0 left-0 grid grid-cols-10 gap-x-6 p-6 z-50"}>
        ...
        <section className={"relative h-screen"}>
            ...
            <div className={"absolute grid grid-cols-10 gap-x-6 px-6 left-0 top-[75%] -translate-y-[50%]"}>
                <p className={"col-start-6 col-span-5 text-[42px] leading-none tracking-tighter"}>You've ventured too far into the canvas! There's nothing here but potential. Let's go back and see the completed works.</p>
            </div>
        </section>
    </main>
  );
